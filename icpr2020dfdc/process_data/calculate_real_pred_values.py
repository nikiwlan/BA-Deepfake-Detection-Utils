...
def main(dataset):
    ...
    if dataset == 'FF++':
        ...
        real_dirs = [
            '/media/niklas/T7/CustomDataset/Real'
        ]
        prediction_file_real = 'prediction_real_values_custom.txt'
    else:
    ...
    prediction_file_path = os.path.join(prediction_dir, prediction_file_real)
